    ...
    <div class="col-lg-7 mb-5 m-auto">
        <form action="" method="post" class="container my-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea rows="5" type="text" id="text" name="text" class="form-control"><?=$post['text']?></textarea>
                <span><?=$errors['text'] ?? ''?></span>
            </div>
            <div class="mb-3">
                <label for="editor" class="form-label">Main Text</label>
                <textarea name="post-content" id="editor" class="form-control"><?=base64_decode($post['main_text'])?></textarea>
                <span><?=$errors['mainText'] ?? ''?></span>
            </div>
            <div class="mb-3 row">
                <div class="col-md-4">
                    <label for="image" class="form-label">Image of your post</label>
                    <input type="file" value="<?$post['image']?>" id="image" name="image" class="form-control">
