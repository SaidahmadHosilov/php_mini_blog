...
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('/template/images/img_2.jpg');">
    <div class="container">
        ...
        <div class="col-md-12 col-lg-10">
            ...
            <div class="post-meta align-items-center text-center">
                <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="/template/images/person_1.jpg" alt="Image" class="img-fluid"></figure>
    ...
    <div class="container">
        ...
        <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="bio text-center">
                <img src="/template/images/person_2.jpg" alt="Image Placeholder" class="img-fluid mb-5">
                <div class="bio-body">
                <h2>Craig David</h2>
            ...
            <div class="post-entry-sidebar">
                ...
                <li>
                    <a href="">
                    <img src="/template/images/img_1.jpg" alt="Image placeholder" class="mr-4">
                    <div class="text">
                ...
                <li>
                    <a href="">
                    <img src="/template/images/img_2.jpg" alt="Image placeholder" class="mr-4">
                    <div class="text">
                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                        <div class="post-meta">
                        <span class="mr-2">March 15, 2018 </span>
                ...
                <li>
                    <a href="">
                    <img src="/template/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                    <div class="text">
                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                        <div class="post-meta">
                        <span class="mr-2">March 15, 2018 </span>
